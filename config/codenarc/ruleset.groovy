ruleset {
    ...
    LocaleSetDefault
    // NestedForLoop
    // PrivateFieldCouldBeFinal - when fields in tests are final runner will fail to find tests - "Empty test suite."
    PublicInstanceField
    ...
    // unsupported rules. see: http://codenarc.sourceforge.net/codenarc-enhanced-classpath-rules.html
